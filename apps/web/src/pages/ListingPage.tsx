...
import { Flag, MessageCircle, Tag } from "lucide-react";
    ...
    <div className="mx-auto max-w-xl px-4 py-6">
      ...
      {!isOwn && listing.status === "active" && (
        <button
          ...
          className="mt-4 flex w-full items-center justify-center gap-2 rounded-lg bg-brand-yellow px-4 py-2.5 text-sm font-semibold text-black hover:bg-brand-orange disabled:opacity-60"
        >
      ...
      {isOwn && listing.status === "active" && (
        <div className="mt-4 flex gap-3">
          <button
            ...
            className="w-full rounded-lg bg-brand-yellow px-4 py-2.5 text-sm font-semibold text-black hover:bg-brand-orange disabled:opacity-60"
          >
            Mark as sold
          </button>
          <button
